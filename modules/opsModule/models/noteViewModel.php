...
<style type="text/css">
    ...
    .comments-container .avatar img { -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; }
    ...
    .comments-container .prev-comment-area .comments-head {border-bottom: 2px solid #EEE;margin-bottom: 20px}
    ...
    .comments-container .prev-comment-area .comments-head li a {display: block;}
    ...
    .comments-container .user-comment-erea .form-control { -webkit-border-radius: 0; -moz-border-radius: 0; border-radius: 0; }
    .comments-container .prev-comment-area .comment {margin-bottom: 30px}
    .comments-container .prev-comment-area .comment .comment-body {padding-left: 30px}
    .comments-container .prev-comment-area .comment .comment-body .commenter-detail .commenter-link {font-weight: bolder; display: inline}
    .comments-container .prev-comment-area .comment .comment-body .commenter-detail .comment-date {display: inline;color:#AAA;font-weight: bold;font-size: small}
    .comments-container .prev-comment-area .comment .comment-body .commenter-detail .comment-date::before {content: " . "}
    .comments-container .prev-comment-area .comment .comment-body .comment-data {margin: 10px; overflow: auto;}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer {margin: 0 10px ;}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer .vote { text-decoration: none}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer .vote:hover { font-weight: bold}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer > * {display: inline;padding: 3px;}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer .divider {padding-top: -10px}
    .comments-container .prev-comment-area .comment .comment-body .comment-footer .divider::after {content: "."}
    ...
    @media screen and (min-width:0px) and (max-width: 700px) {
        .comments-container .prev-comment-area .comment .comment-body {padding-left: 10px}
    }
</style>
<div class="row">
    <div class="col-md-push-2 col-md-8 comments-container" astyle="border: 1px solid #000;min-height: 100px">
...
<?php else: ?>
                <div class="hidden-xs col-sm-1 avatar" sstyle="height: 50px;border: 1px solid #000;padding: 0">
